    ...
    <footer className="bg-ocean-blue-900 text-white">
      <div className="container mx-auto px-4 py-12">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          <div className="col-span-1 md:col-span-1">
            ...
            <p className="text-gray-300 text-sm mt-4">
              沖縄の美しい海で最高のマリンアクティビティ体験をご提供します。
            </p>
          </div>

          <div className="col-span-1">
            <h3 className="text-lg font-bold mb-4">アクティビティ</h3>
            <ul className="space-y-2">
              <li>
                <Link
                  href="/activity/jet-ski"
        ...
        <div className="mt-12 pt-8 border-t border-gray-600 text-center text-sm text-gray-400">
          <p>
            &copy; {new Date().getFullYear()} 沖縄マリンアクティビティ. All
            rights reserved.
          </p>
        </div>
      </div>
